...
from server.db.repositories import UserRepository, DeviceRepository
from server.db.schemas import UserCreate, DeviceCreate, UserResponse
...
# 여기에 작성:
    ...
    async def register_user_and_device(self, user_data: UserCreate, device_data: DeviceCreate) -> UserResponse:
        ...
        if not device:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Device UUID is registered to another user")
