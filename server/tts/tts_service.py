...
def get_tts_service() -> TTSService:
    ...
    try:
        ...
        logger.error(f"[TTS] SupertonicTTSService 초기화 실패: {e}")
        return NullTTSService()
