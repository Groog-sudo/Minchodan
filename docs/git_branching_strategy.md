...
- 작업 완료 후 [`docs/changelogs/`](changelogs/) 내의 본인 이니셜 파일(예: `kb.md`) 상단에 [`TEMPLATE.md`](changelogs/TEMPLATE.md) 양식을 적용하여 변경 사항을 누적하여 기록하고, [`docs/changelogs/README.md`](changelogs/README.md) 목록의 날짜를 갱신합니다.
