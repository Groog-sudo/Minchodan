...
def main():
    parser = argparse.ArgumentParser(
        description="Prepare YOLO Classification Dataset from Object Detection folders."
    )
    parser.add_argument(
        "--indoor_dir",
        type=Path,
        default=Path("datasets/segmentation/indoor/images"),
        help="Path to indoor images",
    )
    parser.add_argument(
        "--outdoor_dir",
        type=Path,
        default=Path("datasets/object_detection/outdoor/images"),
        help="Path to outdoor images",
    )
    parser.add_argument(
        "--output_dir",
        type=Path,
