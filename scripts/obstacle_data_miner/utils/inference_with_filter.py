...
def main():
    parser = argparse.ArgumentParser(description="2-Stage Inference: Indoor/Outdoor Classifier -> Object Detector")
    parser.add_argument("--img", type=str, required=True, help="Path to input image")
    parser.add_argument("--cls_model", type=str, default="runs/classify/indoor_outdoor_cls/weights/best.pt", help="Path to classification model")
    parser.add_argument("--det_model", type=str, default="yolov8n.pt", help="Path to object detection model")
    ...
    outdoor_only_classes = [
        "traffic_light", "traffic_light_controller", "traffic_sign", "tree_trunk",
        "pole", "bollard", "parking_meter", "car", "bus", "truck", "motorcycle",
        "scooter", "bicycle", "barricade"
    ]
